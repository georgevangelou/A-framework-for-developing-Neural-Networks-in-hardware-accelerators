...
//#define DATA_INTEGER_WIDTH 5 //  8% accuracy
//#define DATA_INTEGER_WIDTH 6 // 48% accuracy
//#define DATA_INTEGER_WIDTH 7 // 92% accuracy
#define DATA_INTEGER_WIDTH 8 // 96% accuracy
#define DATA_FRACTIONAL_WIDTH 2 //setting to 3 raises the accuracy to 98%
#define DATA_BIT_WIDTH DATA_INTEGER_WIDTH + DATA_FRACTIONAL_WIDTH

#define WEIGHTS_BIT_WIDTH 8
#define WEIGHTS_INTEGER_WIDTH 1

//Convolutional Layer 1
#define CL1_INP_BW DATA_BIT_WIDTH
#define CL1_INP_IW DATA_INTEGER_WIDTH
#define CL1_WEI_BW WEIGHTS_BIT_WIDTH
#define CL1_WEI_IW WEIGHTS_INTEGER_WIDTH
...
#define CL2_WEI_BW WEIGHTS_BIT_WIDTH
#define CL2_WEI_IW WEIGHTS_INTEGER_WIDTH
...
#define DL1_WEI_BW WEIGHTS_BIT_WIDTH
#define DL1_WEI_IW WEIGHTS_INTEGER_WIDTH
...
#define DL2_WEI_BW WEIGHTS_BIT_WIDTH
#define DL2_WEI_IW WEIGHTS_INTEGER_WIDTH
...
#define DL3_WEI_BW WEIGHTS_BIT_WIDTH
#define DL3_WEI_IW WEIGHTS_INTEGER_WIDTH
