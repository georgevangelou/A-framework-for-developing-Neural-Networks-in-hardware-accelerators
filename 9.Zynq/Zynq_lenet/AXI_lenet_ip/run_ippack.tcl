...
## Variables
set Top "ActivateNetwork"
set TopNoPrefix "ActivateNetwork"
...
set Interfaces {
    s_axi_LENET_AXI {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_LENET_AXI"
        param_prefix "C_S_AXI_LENET_AXI"
        addr_bits "11"
        ...
        memories "input_image_V {base_address 1024 range 1024}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 122769 II x}
