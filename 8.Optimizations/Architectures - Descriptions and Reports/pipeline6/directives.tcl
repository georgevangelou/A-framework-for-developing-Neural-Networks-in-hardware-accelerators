...
set_directive_pipeline "conv_layer1/conv_layer1_kernel_2_loop"
set_directive_pipeline "conv_layer2/conv_layer2_kernel_2_loop"
set_directive_array_partition -type complete -dim 3 "avg_pooling_layer1" input
set_directive_array_partition -type cyclic -factor 2 -dim 2 "conv_layer1" input
set_directive_array_partition -type cyclic -factor 2 -dim 3 "conv_layer2" input
set_directive_array_partition -type complete -dim 2 "avg_pooling_layer1" input
